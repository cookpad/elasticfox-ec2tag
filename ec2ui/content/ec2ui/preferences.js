...
var ec2ui_prefs = {
    ...
    getEndpointMap : function() {
        ...
        if (endpointmap == null) {
            ...
            endpointmap['ap-southeast-1'] = new Endpoint('us-west-1', 'https://ec2.ap-southeast-1.amazonaws.com');
            endpointmap['ap-northeast-1'] = new Endpoint('us-west-1', 'https://ec2.ap-northeast-1.amazonaws.com');
        }
